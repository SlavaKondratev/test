...
public class TestController {
    ...
    public String test(@PathVariable String input) {
        ...
        //Реверс строки равносилен перестановке симметричных относительно середины строки символов
        //Перестановка требуется только при отличии симметричных символов
        //Если в строке нечетное число символов то средний символ всегда остается на своем месте
